...
\usepackage{amssymb}
\usepackage[automark]{scrlayer-scrpage} %headsepline for a line below header
...
\renewcommand\Pr{\mbox{\textit{Pr}}}


% Biblatex
% \input{preamble/biblatex} % do not use this
\usepackage[sort]{natbib} %[sort] sort some citations but no some others :|
\setcitestyle{year}
