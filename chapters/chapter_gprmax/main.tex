...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/chapter_gprmax/Fig01.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/chapter_gprmax/Fig02.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/chapter_gprmax/Fig03.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/chapter_gprmax/Fig04.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{chapters/chapter_gprmax/Fig06.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/chapter_gprmax/Fig07.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{chapters/chapter_gprmax/Fig08.pdf}
