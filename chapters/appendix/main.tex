\chapter{Supplementary materiel for Chapter~\ref{ch:chapter_plainemorte}: calculation of $\Nu$ as a function of the e-folding length $x_0$}
\label{sec:appendixA}
...
\chapter{Supplementary materiel for Chapter~\ref{ch:chapter_plainemorte}: salt dilution experiments in the supraglacial channel}
\label{sec:appendixB}
...
\chapter{Supplementary material for Chapter~\ref{ch:chapter_WPOFs}}
...
\begin{sidewaystable}
    ...
    \begin{tabular}{l l l c c c l r}
        ...
        \hline
        Findelgletscher & 2017-07-04 & temp. bloc. & \makecell{cut-off$^{+,*}$ \\ see Fig.~\ref{fig:IceBlockage}b} & \makecell{before$^+$ \\ after$^+$} & - & no & cantonal report (Wallis) \\
        \hline
        ...
        \hline
        Hubelgletscher & 2004-08-04 & temp. bloc. &  \makecell{sharp rise$^+$ \\ see Fig.~\ref{fig:IceBlockage}d} & after$^*$ & -  & photograph & {\cite{fink2004}} \\
        \hline
        \makecell[l]{Oberer \\Grindelwaldgletscher} & 2011-06-29 & temp. bloc. & sharp rise$^+$ & - & -  & no & {\cite{Hahlen2011}} \\
        \hline
        \makecell[l]{Oberer \\Grindelwaldgletscher} & 2011-08-25 & temp. bloc. & \makecell{cut-off$^+$ \\ see Fig.~\ref{fig:IceBlockage}c} & - & -  & no & {\cite{Hahlen2011}} \\
        \hline
